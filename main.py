...
def folderSetup():
    print("Source Organiser Version 1.0.0.6. Copyright (c) 2025-2026 Nicholas Lim.")
    global defaultpath
    if osname == "nt":
            ...
            while True:
                ...
                if name not in directories:
                    ...
                    try:
                        ...
                        print("Warning: Default files for new folder could not be found.\nYou can still use this folder, but default files will not be included.")
                    mainInterface(name)
                    sys.exit()
                else:
